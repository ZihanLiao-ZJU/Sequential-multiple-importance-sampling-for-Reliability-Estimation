classdef LSF_2D_ChangingToplogical
    % LSF with changing topological structure in standard normal space
    %
    % Definition
    % ---------------------------------------------------------------------
    % L(theta) = d
    %          + c1 / ( ( b1*(theta1-a1)^2 + b2*(theta2-a2)^2 )^2 + 1 )
    %          + c2 / ( ( b3*(theta1-a3)^2 + b4*(theta2-a4)^2 )^2 + 1 )
    ...
    properties
        ...
        % -----------------------------------------------------------------
        % Parm   LSF parameters packed as [a1;a2;a3;a4;b1;b2;b3;b4;c1;c2;d]      double [11,1]
    ...
    methods
        function L = EvlLSF(obj,theta)
            ...
            % Notes
            % -----------------------------------------------------------------
            % - The LSF is a superposition of two smooth, localized terms whose
